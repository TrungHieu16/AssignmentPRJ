<%-- 
    Document   : home
    Created on : Feb 27, 2022, 9:12:58 PM
    Author     : Trung Hieu
--%>
  ...
  <body>
    ...
    <div class="site-wrap" id="home-section">
      ...
      <header class="site-navbar site-navbar-target" role="banner">
        ...
        <div class="container">
          <div class="row align-items-center position-relative">
            ...
            <div class="col-3">
              <div class="site-logo">
                <a href="index.html"><strong>AUTO H16CAR</strong></a>
              </div>
            </div>
                ...
                <div class="row align-items-center">
                  ...
                  <div class="mb-3 mb-md-0 col-md-3">
                    <div class="form-control-wrap">
                      <input type="text" id="cf-3" placeholder="Ngày thuê xe" class="form-control datepicker px-3">
                  ...
                  <div class="mb-3 mb-md-0 col-md-3">
                    <div class="form-control-wrap">
                      <input type="text" id="cf-4" placeholder="Ngày trả xe" class="form-control datepicker px-3">
                      <span class="icon icon-date_range"></span>
                    </div>
                  </div>
                  <div class="mb-3 mb-md-0 col-md-3">
      ...
      <div class="site-section">
        <div class="container">
          <h2 class="section-heading"><strong>Làm thế nào để thuê được xe?</strong></h2>
          <p class="mb-5">Các bước như sau:</p>    
            ...
            <div class="col-lg-4 mb-4 mb-lg-0">
              <div class="step">
                ...
                <div class="step-inner">
                  ...
                  <h3>Điền thông tin cá nhân của bạn</h3>
                  <p></p>
                </div>
              </div>
            </div>
